#-------------------------------------------------
#
# Project created by QtCreator 2016-11-01T23:58:26
#
#-------------------------------------------------

QT       -= core gui

TARGET = karaokemanager
TEMPLATE = lib
CONFIG += staticlib

SOURCES += src/karaokemanager/karaokemanager.cpp \
    src/karaokemanager/videoinfo.cpp

HEADERS += src/karaokemanager/karaokemanager.h \
    src/karaokemanager/videoinfo.h
unix {
    target.path = /usr/lib
    INSTALLS += target
}
